---
name: coordinator
description: Orchestrate multiple workmux worktree agents from Codex. Use when the user asks to coordinate, dispatch, monitor, message, wait on, or merge multiple parallel worktree agents.
---
...
Tell the agent to use the merge skill on its own branch. This lets the agent
handle rebasing and conflict resolution.

```bash
# Tell agent to commit, rebase, and merge
workmux send agent-a "Use the merge skill to commit, rebase, and merge this branch"
...
workmux send auth-module "Use the merge skill to commit, rebase, and merge this branch"
workmux wait auth-module --timeout 120
workmux send api-tests "Use the merge skill to commit, rebase, and merge this branch"
...
workmux send docs-update "Use the merge skill to commit, rebase, and merge this branch"
```
...
5. **Merge one at a time** by asking each agent to use the merge skill sequentially. Wait
