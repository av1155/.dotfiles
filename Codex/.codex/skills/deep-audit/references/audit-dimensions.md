...
If browser automation tools are available (Playwright MCP, Codex-in-Chrome) and the project has a dev server, consider actually loading the page and testing the feature. This is optional and should not block the audit.
