---
name: open-pr
description: Write a concise pull request title and description from git diff, commits, changed files, and conversation context, then open PR creation in the browser. Use when the user asks to open, draft, create, or prepare a PR.
---
