---
name: rebase
description: Rebase the current branch with careful conflict resolution. Use when the user asks to rebase, update from main, rebase onto origin/main or another branch, or resolve rebase conflicts while preserving both sides.
---
...
Use any target branch or remote provided in the user's request as the rebase target.
