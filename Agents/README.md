...
- `Claude/.claude/skills/<name>` → `Agents/.agents/skills/<name>` (description-discovered: commenting, security, playwright-cli, caveman, diagnose, grill-me, grill-with-docs, improve-codebase-architecture, setup-matt-pocock-skills, tdd, to-issues, to-prd, triage, zoom-out)
